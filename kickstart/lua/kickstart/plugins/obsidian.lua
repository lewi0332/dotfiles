return {
  ...
  keys = {
    ...
    -- Search for files in vault
    {
      '<leader>os',
      function()
        require('telescope.builtin').find_files { search_dirs = { '~/Documents/Obsidian Vault' } }
      end,
      desc = '[O]bsidian: [S]earch files',
    },
    ...
    -- Live grep in vault
    {
      '<leader>oz',
      function()
        require('telescope.builtin').live_grep { search_dirs = { '~/Documents/Obsidian Vault' } }
      end,
      desc = '[O]bsidian: Grep (fuzzy [Z])',
    },
